...
<tr id="wrapper" style="border: 1px solid #ddd">
    <td colspan="2">
...
<li id="tab" class="nav-item call-tab">
...
<div id="notes"> <!-- We are throwing out the TD below here because its not in a table T_T -->
...
<button id="adhoc" type="button" class="btn btn-primaryrc btn-sm position-absolute adhocButton" data-toggle="modal" data-target="#MODALID">TEXT</button>

<!-- We replace the ID here -->
